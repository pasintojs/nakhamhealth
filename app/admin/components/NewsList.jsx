...
export default function NewsList({ onEdit }) {
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="flex flex-wrap gap-2">
          ...
          >
            เผยแพร่แล้ว ({news.filter((n) => n.is_published).length})
          </button>
          <button
          ...
          >
            แบบร่าง ({news.filter((n) => !n.is_published).length})
          </button>
      ...
      {filteredNews.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-slate-500">ไม่พบข่าวสาร</p>
        </div>
      ) : (
