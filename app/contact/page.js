      ...
      <section className="py-16 sm:py-20 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="max-w-5xl mx-auto">
            {/* Hospital Info Card - Full Width Featured */}
            <div className="mb-16">
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-cyan-200/50 hover:shadow-3xl transition-all duration-500">
                {/* <div className="text-center mb-8">
                  <div className="w-24 h-24 bg-gradient-to-br from-sky-500 to-cyan-500 rounded-3xl flex items-center justify-center text-white text-4xl shadow-xl mx-auto mb-6">
                    🏥
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
                  <div className="flex items-center gap-4 text-slate-700">
                    ...
                    <div>
                      <div className="font-semibold">ที่ตั้ง</div>
                  ...
                  <div className="flex items-center gap-4 text-slate-700">
                    ...
                    <div>
                      ...
                      <div className="text-slate-600">
                        จันทร์-อาทิตย์ ไม่เว้นวันหยุดนักขัตฤกษ์
                      </div>
                    </div>
                  </div>
            ...
            {/* Contact Methods - Featured Section */}
            <div className="mb-16">
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                <a
                  ...
                  className="group flex items-center gap-4 bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-cyan-200/50 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300"
                >
