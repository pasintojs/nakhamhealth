...
export default async function NewsDetailPage({ params }) {
  ...
  const relatedNews = await getRelatedNews(newsItem.category, newsItem.id);
  ...
  const processedTitle = processPlainTextForDisplay(newsItem.title || "");
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="mb-8">
          {newsItem.images && newsItem.images.length > 0 ? (
            <NewsImageSlideshow images={newsItem.images} alt={newsItem.title} />
          ) : newsItem.image_url && newsItem.image_url.trim() !== "" ? (
